...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--gpu", type=int, default=0, help="GPU index to use for hybrid model")
...
async def _run_benchmark(args: argparse.Namespace) -> Dict[str, Any]:
    ...
    sampler_task = asyncio.create_task(
        _gpu_sampler([args.gpu], gpu_samples, sampler_stop, args.sampling_period, bench_start)
    )
...
def main() -> None:
    ...
    if args.json:
        ...
        print("=== Load Balancing Experiment (Hybrid) ===")
