...
class ModelInputForGPUBuilder(ModelRunnerInputBuilderBase[ModelInputForGPU]):
    ...
    class InterDataForSeqGroup:
        ...
        def __init__(
            ...
            *,
            ...
            # Hybrid embeddings: whether this prefill-only seq group should
            # avoid paged-KV writes during prefill (xFormers backend path).
            # Set by add_seq_group based on Engine flag and seq group type.
            self.no_kv_cache_embed: bool = False
    ...
    def add_seq_group(self, seq_group_metadata: SequenceGroupMetadata):
        ...
        # Mark embed-only requests for cacheless prefill (xFormers fast path)
        if is_prompt:
            embed_only = (seq_group_metadata.pooling_params is not None
                          and seq_group_metadata.sampling_params is None)
            flag = self.runner.vllm_config.additional_config.get(
                "embed_no_kv_cache", True)
            inter_data.no_kv_cache_embed = bool(embed_only and flag)
