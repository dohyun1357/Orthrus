...
TaskOption = Literal["auto", "generate", "embedding", "embed", "classify",
                     "score", "reward", "transcription", "hybrid"]

_ResolvedTask = Literal["generate", "embed", "classify", "score", "reward",
                        "draft", "transcription", "hybrid"]

RunnerType = Literal["generate", "pooling", "draft", "transcription", "hybrid"]
...
class ModelConfig:
    ...
    def __post_init__(self) -> None:
        ...
        self.pooler_config = self._init_pooler_config(self.override_pooler_config)
    ...
    def _init_pooler_config(
        ...
        if self.runner_type == "pooling" or "hybrid":
    ...
    def _resolve_task(
        ...
        if registry.is_text_generation_model(architectures):
            supported_tasks_lst.append("hybrid")
...
class VllmConfig:
    ...
    def __post_init__(self):
        ...
        if self.model_config and self.model_config.pooler_config:
            ...
            if self.model_config.runner_type != "hybrid":
