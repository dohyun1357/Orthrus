...
class AsyncLLMEngine(EngineClient):
    ...
    async def generate(
        ...
        """
        try:
            # print(f"Adding generation request {request_id}")
    ...
    async def encode(
        ...
        try:
            async for output in await self.add_request(
                ...
                # print(f"Adding embedding request {request_id}")
    ...
    # ) -> AsyncGenerator[RequestOutput, None]:
    #     """
    #     Asynchronous hybrid generation for the 'hybrid' runner.
    #     This method adds a hybrid generation request and yields RequestOutput objects.
    #     """
    #     try:
    #         async for output in await self.add_request(
    #                 request_id,
    ...
    # ) -> AsyncGenerator[PoolingRequestOutput, None]:
    #     """
    #     Asynchronous hybrid embedding for the 'hybrid' runner.
    #     This method adds a hybrid embedding request and yields PoolingRequestOutput objects.
    #     """
    #     if self.engine.model_config.runner_type != "hybrid":
    #         raise ValueError(
    #             "AsyncLLMEngine.hybrid_embed() is only supported for task = hybrid. "
    #             "Please initialize the engine with --task hybrid."
    #         )

    #     if prompt_token_ids is not None:
    #         parsed_prompt = self.engine._convert_v1_inputs(prompt, prompt_token_ids)
    #     else:
